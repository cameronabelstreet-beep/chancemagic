...
export function FeatureCarousel() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto md:p-8">
      <div className="relative overflow-hidden rounded-[2.5rem] lg:rounded-[4rem] flex flex-col lg:flex-row min-h-[600px] lg:aspect-video border border-surface-mid">
        <div className="w-full lg:w-[40%] min-h-[350px] md:min-h-[450px] lg:h-full relative z-30 flex flex-col items-start justify-center overflow-hidden px-8 md:px-16 lg:pl-16 bg-surface">
                ...
                >
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-on-background text-background border-on-background z-10"
                        : "bg-transparent text-on-surface/60 border-accent/30 hover:border-accent/60 hover:text-on-background"
                    )}
                  >
                    <div
                      className={cn(
                        "flex items-center justify-center transition-colors duration-500",
                        isActive ? "text-background" : "text-on-surface/40"
                      )}
                    >
                      <HugeiconsIcon
                        icon={feature.icon}
        ...
        <div className="flex-1 min-h-[500px] md:min-h-[600px] lg:h-full relative bg-surface/30 flex items-center justify-center py-16 md:py-24 lg:py-16 px-6 md:px-12 lg:px-10 overflow-hidden border-t lg:border-t-0 lg:border-l border-surface-mid">
              ...
              return (
                ...
                >
                  ...
                  <AnimatePresence>
                    {isActive && (
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(to top, rgba(0,0,0,0.9), rgba(0,0,0,0.4) 40%, transparent 100%)",
                        }}
                      >
                        <div className="bg-background text-on-background px-4 py-1.5 rounded-full text-[11px] font-normal uppercase tracking-[0.2em] w-fit mb-3 border border-accent/50">
                          {index + 1} • {feature.label}
                        </div>
                        <p className="text-on-background font-normal text-xl md:text-2xl leading-tight tracking-tight">
                          {feature.description}
                        </p>
                      </motion.div>
                    )}
                  ...
                  >
                    ...
                    <span className="text-on-background/80 text-[10px] font-normal uppercase tracking-[0.3em]">
                      Live Session
                    </span>
                  </div>
                </motion.div>
